        ...
        <div class="ha-powerflow-widget"
            ...
            <svg id="ha-pf-svg" viewBox="0 0 1000 700"
                ...
                <path id="ha-pf-heatpump-path" class="ha-pf-laser"
                      d="<?php echo esc_attr( $heatpump_line ); ?>"
                      fill="none" stroke="<?php echo esc_attr( $heatpump_color ); ?>"
                ...
                <!-- ── Grid label block ──────────────────────────────────────── -->
                <text x="<?php echo $gx; ?>" y="<?php echo $gy; ?>"
                      text-anchor="middle" fill="<?php echo esc_attr( $title_color ); ?>"
                      font-family="'Exo 2', sans-serif"
                ...
                <text id="ha-pf-grid-power"
                      ...
                      text-anchor="middle" fill="<?php echo esc_attr( $power_color ); ?>"
                ...
                <?php if ( ! empty( $o['enable_solar'] ) ) : ?>
                <!-- ── PV label block ────────────────────────────────────────── -->
                <text x="<?php echo $px; ?>" y="<?php echo $py; ?>"
                      text-anchor="middle" fill="<?php echo esc_attr( $title_color ); ?>"
                      font-family="'Exo 2', sans-serif"
                      font-size="11" font-weight="700" letter-spacing="2"
                ...
                <?php if ( ! empty( $o['enable_battery'] ) ) : ?>
                <!-- ── Battery label block ───────────────────────────────────── -->
                <text x="<?php echo $bx; ?>" y="<?php echo $by; ?>"
                      text-anchor="middle" fill="<?php echo esc_attr( $title_color ); ?>"
                      font-family="'Exo 2', sans-serif"
                      font-size="11" font-weight="700" letter-spacing="2"
                ...
                <?php if ( ! empty( $o['enable_ev'] ) ) : ?>
                <!-- ── EV label block ────────────────────────────────────────── -->
                <text x="<?php echo $ex; ?>" y="<?php echo $ey; ?>"
                      text-anchor="middle" fill="<?php echo esc_attr( $title_color ); ?>"
                      font-family="'Exo 2', sans-serif"
                      font-size="11" font-weight="700" letter-spacing="2"
                ...
                <text x="<?php echo $hx2; ?>" y="<?php echo $hy2; ?>"
                      text-anchor="middle" fill="<?php echo esc_attr( $title_color ); ?>"
                      font-family="'Exo 2', sans-serif"
                      font-size="11" font-weight="700" letter-spacing="2"
